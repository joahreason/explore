...
- [x] 5. chunk_manager.gd split, §4.1 steps 1-9 (A2 in view modes, A3 in content, A4 and T4 throughout, O1 folders in step 9) - PRs #45-#52 and step 9's (merged into review-followup)
