...
## its base stays planted; Wind (scripts/render/wind.gd) sets direction and gusts.
...
## Phase 14: a QualityProfile (scripts/resources/quality_profile.gd) rating each placed
